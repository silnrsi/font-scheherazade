...
#--------------------------------
    ...
    if test.lower().startswith("allchars"):
        ...
        ftml.addToTest(0xFDF2, r"\uFDF2", comment="Rule 10\n(was 1)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0651\u0670\u0647\u064F", label="a-l-l-s-da-hf-dma", comment="Rule 1b (daggeralef)\n(was 2)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0670\u0651\u0647\u064F", label="a-l-l-da-s-hf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0651\u0670\u06C1\u064F", label="a-l-l-s-da-hgf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0670\u0651\u06C1\u064F", label="a-l-l-da-s-hgf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0651\u064E\u0647\u064F", label="a-l-l-s-f-hf-dma", comment="Rule 1b+4 (fatha)\n(was 2)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u064E\u0651\u0647\u064F", label="a-l-l-f-s-hf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u0651\u064E\u06C1\u064F", label="a-l-l-s-f-hgf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0644\u064E\u0651\u06C1\u064F", label="a-l-l-f-s-hgf-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u065A\u0644\u064E\u0651\u06C1", label="a-l-M-l-s-da-hgf", comment="Rule 3: shouldn't match\n(was 3b)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u0650\u0644\u064E\u0651\u06C1\u064F", label="a-l-k-l-s-da-hgf-dma", comment="Rule 3\n(was 3b)")
        ftml.setLang('sd')
        ftml.addToTest(None, r"\u0627\u0644\u0650\u0644\u064E\u0651\u06C1\u064F", label="a-l-k-l-s-da-hgf-dma", comment="Rule 3 (Sindhi)\n(was 3b, Sindhi)")
        ftml.clearLang()
        ftml.closeTest()
        ftml.addToTest(None, r"\u0641\u0644\u0644\u064E\u0651\u06C1\u064F", label="f-l-l-s-da-hgf-dma", comment="Rule 1b: non-alef\n(was 2d)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0641\u0627\u0644\u0644\u064E\u0651\u06C1\u064F", label="f-a-l-l-s-da-hgf-dma", comment="Rule 1b: final alef\n(was 2d)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u065A\u0644\u0644\u064E\u0651\u06C1\u064F", label="a-M-l-l-s-da-hgf-dma", comment="Rule 1b+2: Mark\n(was 2d)")
        ftml.closeTest()
        ftml.addToTest(None, r" \u0644\u0644\u0651\u064E\u0647\u064F", label="space-l-l-s-da-hf-dma", comment="Rule 1b+4 (space before)\n(was 2)")
        ftml.closeTest()

        ftml.addToTest(None, r"\u0627\u0644\u0644\u0647\u064F", label="a-l-l-h-dma", comment="Rule 1a  (various alef)\n(was 3)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0622\u0644\u0644\u0647\u064F", label="aM-l-l-h-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0623\u0644\u0644\u0647\u064F", label="aH-l-l-h-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0671\u0644\u0644\u0647\u064F", label="aW-l-l-h-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u065A\u0644\u0644\u0647\u064F", label="a-M-l-l-h-dma")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0641\u0644\u0644\u0647", label="f-l-l-h", comment="Rule 1 not satisfied: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0641\u0627\u0644\u0644\u0647", label="f-a-l-l-h", comment="Rule 1 not satisfied: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u065A\u0644\u0647", label="a-l-M-l-h", comment="Rule 1 not satisfied: shouldn't match")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u200D\u0644\u0647", label="a-l-zwj-l-h", comment="Rule 9 (ZWJ): shouldn't match\n(was 4a)")
        ftml.closeTest()
        ftml.addToTest(None, r"\u0627\u0644\u200D\u0644\u0651\u0670\u0647", label="a-l-zwj-l-s-da-h", comment="Rule 9 (ZWJ): shouldn't match\n(was 4a)")
        ftml.closeTest()
